...
#the following 3 lines define the range of phase in the scan.243, 0.0465
nsteps = 30
inival = 185
delval = 3
...
while newValueIndex < nsteps:
    ...
    os.system('sed -n \'23966,+0p\' TIMESTEPEMITTANCE.TBL >> tmpeng')
    os.system('echo '+str(val)+' >> tmpphase')
    os.system('sed -n \'23966,+0p\' TIMESTEPEMITTANCE.TBL')
